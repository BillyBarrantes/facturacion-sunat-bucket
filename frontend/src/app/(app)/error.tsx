...
export default function AppError({ error, reset }: ErrorProps) {
  return (
    <div className="min-h-screen bg-[var(--bg)] flex flex-col items-center justify-center px-6 py-16 text-center">
      <div className="max-w-md space-y-5">
        <div className="mx-auto w-12 h-12 rounded-full bg-[var(--danger-soft)] flex items-center justify-center">
        ...
        <div>
          ...
          <p className="text-[14px] text-[var(--muted)] mt-2 leading-[var(--leading-body)]">
            Ocurrió un error inesperado al cargar esta sección. Podés intentar de nuevo.
          </p>
        </div>
